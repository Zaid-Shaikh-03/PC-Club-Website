      ...
      <div className="group relative mb-auto mt-auto flex h-auto w-auto transform overflow-hidden rounded-lg bg-white shadow-xl transition duration-500 ease-in-out hover:scale-105 sm:hidden">
        ...
        <div>
          ...
          <a
            href={resources.href}
            target="_blank"
            className=" focus:outline-none float-right m-2 mb-5 mr-3 w-24 rounded-full bg-red-600 p-2 pl-4 text-center font-semibold text-white shadow-lg transition-all duration-300 hover:bg-red-700 hover:shadow-none focus:ring"
          >
            {" "}
            {resources.button}
          </a>
      ...
      <div className="group relative mb-auto mt-auto hidden h-full w-full transform overflow-hidden rounded-lg bg-white shadow-xl transition duration-500 ease-in-out hover:scale-105 sm:block">
        ...
        <div>
          ...
          <a
            href={resources.href}
            target="_blank"
            className=" focus:outline-none float-right m-2 mb-5 mr-3 w-32 rounded-full bg-green-400 p-2 pl-4 text-center font-semibold text-white shadow-lg transition-all duration-300 hover:bg-green-800 hover:shadow-none focus:ring"
          >
            {" "}
            {resources.button}
          </a>
