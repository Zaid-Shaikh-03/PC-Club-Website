    ...
    <div className=" text-gray-800 ">
      <div className="flex flex-col md:flex-row gap-y-4 justify-between md:items-center bg-header xl:px-36 md:px-12 px-6 py-10">
        <h1 className=" font-bold text-4xl md:text-5xl text-white">
          Algorithm <span className="text-green-600">8.O</span>
        </h1>
        <a
        target={'_self'}// isko blank kar ke yaha par algo ki website ki link aaegi
        ...
        <div>
          ...
          <p>
            <ul className=" ml-8  space-y-2">
              ...
              <li className=" list-disc">
                36-hour coding contest, hosted by Programmer's Club.
              </li>
              <li className=" list-disc">
                There would be 10-12 Problem Statement to solve You have to choose one of them
              </li>
              <li className=" list-disc">
